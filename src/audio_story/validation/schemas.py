...
SCHEMAS = {
    ...
    for spec in (
        ...
        SchemaSpec("visual_plan.json", "1.0", ("INPUT", "OUTPUT"), None, "NOT_VERIFIED"),
        SchemaSpec("visual_bible.json", "1.0", ("INPUT", "OUTPUT"), None, "NOT_VERIFIED"),
        SchemaSpec("stage_image_progress.json", "1.0", ("INPUT", "OUTPUT"), None, "NOT_VERIFIED"),
